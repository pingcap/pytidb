...
- `embeddings/`: abstract base plus built-in providers (OpenAI, Jina, etc.), dimension metadata, and utilities for converting sources or queries. `EmbeddingFunction.VectorField` wires server-side or client-side embeddings transparently.
