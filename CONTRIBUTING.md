...
- `schema.py`: builds on SQLModel to define `TableModel`, `VectorField`, `FullTextField`, distance metrics, and helper metadata that the rest of the stack consumes. This is how contributors declare tables, indexes, and embedding behavior.
