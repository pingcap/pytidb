...
@pytest.mark.parametrize("test_case", FILTER_TEST_CASES, ids=lambda x: x.name)
def test_filters(test_filters_table, test_case: FilterTestCase):
    result = test_filters_table.query(test_case.filters)
