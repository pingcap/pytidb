...
class BaseEmbeddingFunction(BaseModel, ABC):
    ...
    embedding_model: Optional[str] = Field(
        None, description="The name of embedding model used for embedding", alias="model_name"
    )
    ...
    def model_name(self) -> Optional[str]:
        """Access the embedding model name for backward compatibility."""
        return self.embedding_model

    @model_name.setter
    def model_name(self, value: Optional[str]) -> None:
        """Set the embedding model name for backward compatibility."""
